...
class _ParameterizedQuantumGate:
    ...
    Attributes:
        ...
        op_name: Name of the original operator class
    """


_ParameterizedQuantumGate = namedtuple(
    "Gate", ["matrix_generator", "wires", "params", "trainable_idx", "input_idx", "inverse", "op_name"]
)
...
class ParameterizedQuantumCircuit:
    ...
    def append_gate(
        ...
        self._gates.append(
            _ParameterizedQuantumGate(matrix_generator, wires, params, trainable_idx, input_idx, inverse, name)
        )
